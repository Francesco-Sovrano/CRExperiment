...
# python3 reliance_analysis.py --input formatted_results/all --output visualizations_and_statistics/all --keep_only_who_changed_decision --keep_only_who_easily_understood_explanation
...
# python3 reliance_analysis.py --input formatted_results/image_based --output visualizations_and_statistics/image_based --keep_only_who_changed_decision --keep_only_who_easily_understood_explanation
...
# python3 reliance_analysis.py --input formatted_results/text_based --output visualizations_and_statistics/text_based --keep_only_who_changed_decision --keep_only_who_easily_understood_explanation
